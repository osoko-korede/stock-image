...
function App() {
  ...
  const handleImageClick = (image) => {
    setSelectedImage(image); // Set the clicked image to state for zooming
  };
  ...
  return (
    <div className='container'>
      <h1 className='title'>Stock Image Search</h1>
      ...
      <div className='filters'>
        <div onClick={() => handleSelection('random')}>Don't know what to search, <span className='link'> get random images 🏹</span></div>
          ...
          <div className='images'>
            {images.map((image) => (
              <img
                ...
                className='image'
                onClick={() => handleImageClick(image)} // Handle click to zoom in
              />
            ))}
          </div>
